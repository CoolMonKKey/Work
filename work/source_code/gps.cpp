    ...
    while((ptr=readdir(dir))!=nullptr)
    {
        ...
        while(getline(inFile,lineStr))
        {
            ...
            if(second_row)
            {
                ...
                lineStr = lineStr + ',' + current_speed + ",0" + ",0" + ",0";
            ...
            double hor_dis = (atof(hor_spd.c_str()) + atof(last_second_horspd.c_str())) / 2;
            ...
            transverse_a = std::to_string(this_sec_tran_spd - last_sec_trans_spd);
#if 0
